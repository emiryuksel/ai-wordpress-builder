...
/**
 * Solver CMS'e yönlendirme sırasında tüm ekranı kaplayan Apple-like geçiş
 * katmanı. Buğulu cam bir yüzey, nazikçe nefes alan logo ve akıcı bir ilerleme
 * çizgisiyle kullanıcıya yeni bir yere geçtiğini hissettirir.
 */
export default function SolverRedirectOverlay({
  ...
  return createPortal(
    ...
    >
      {/* Buğulu cam zemin + yumuşak mor mesh */}
