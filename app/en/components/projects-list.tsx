...
import DeleteProjectModal from "@/app/en/components/delete-project-modal";
...
export default function ProjectsList({
  ...
  const visibleProjects = useMemo(() => {
    ...
    return [...filtered].sort((a, b) => {
      if (sortMode === "name") {
        return a.siteTitle.localeCompare(b.siteTitle, "en");
      }
      ...
      <div className="glass-strong rounded-[32px] p-6 sm:p-8">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              title={sortMode === "recent" ? "Sorted by date" : "Sorted by name"}
            >
        ...
        {loading ? (
          ...
          <div className="mt-6 rounded-3xl border border-dashed border-black/10 bg-white/40 px-5 py-10 text-center text-sm text-zinc-500">
            You don&apos;t have any projects yet. Send your first prompt to get started.
          </div>
        ) : visibleProjects.length === 0 ? (
          <p className="mt-8 text-sm text-zinc-500">
            No projects matching &quot;{query}&quot; were found.
          </p>
        ) : (
          <div className="relative mt-6">
            ...
            >
              {visibleProjects.map((project) => (
                ...
                >
                  <Link href={`/en/builder/${project.projectId}`} className="block">
                  ...
                  <button
                    ...
                    aria-label={`Delete project ${project.siteTitle}`}
                  >
