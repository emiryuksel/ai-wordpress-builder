...
export default function AdminUsersPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-semibold text-[#1d1d1f]">Members</h1>
        <p className="mt-1 text-sm text-zinc-500">
          All registered users and the sites they created.
        </p>
      </div>
                  ...
                  <tr key={user.id} className="align-top">
                    ...
                    <td className="px-4 py-4">
                      {user.projects.length > 0 ? (
                        ...
                        >
                          {expanded ? "Hide" : "Show sites"}
                        </button>
                      ) : (
                        <span className="text-xs text-zinc-400">No sites</span>
                      )}
                    </td>
                  </tr>
                );
                  ...
                  {user.projects.map((project) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Link
                          href={`/en/builder/${project.projectId}`}
